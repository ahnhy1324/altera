...
set_module_property VERSION 13.0sp1
...
proc my_elaborate {} {
	...
	if {[string compare -nocase [get_parameter_value USE_HARD_FIFOS_INTERNAL] "true"] == 0} {
		if { [string compare -nocase $dev_fam "arriav"] == 0 || [string compare -nocase $dev_fam "cyclonev"] == 0} {	
			...
			add_interface_port hard_fifo_control lfifo_rdata_en export Input [rate_mult [get_parameter_value HALF_RATE_OUTPUT]]
			...
			add_interface_port hard_fifo_control lfifo_rdata_valid export Output 1
